...
$conn = mysqli_connect('localhost', 'root', '', 'kachabazarDB'); //connecting to kachabazar database
if (!$conn) {
...
if (isset($_POST['add_product'])) {
    ...
    //This helps us to insert new product into Grocery_items table
    $insert_query = "INSERT INTO Grocery_items (Groc_name, status, category, description, price, Groc_quantity, SEseller_id) VALUES ('$groc_name', '$status', '$category', '$description', '$price', '$groc_quantity', '$seller_id')";
...
if (isset($_POST['delete_product'])) { //This takes care of deleting the products
    $item_id = $_POST['item_id'];
    // Delete product where item_id matches and seller owns it
...
<form method="POST" action="">
    ...
    <input type="text" name="groc_name" autocomplete="off" required><br><br>
    <label>Status (Available/Out of Stock):</label><br>
    ...
    <textarea name="description" rows="3" cols="30" autocomplete="off"></textarea><br><br>
    <label>Price:</label><br>
    <input type="number" name="price" step="0.01" required><br><br>
    <label>Quantity:</label><br>
    <input type="number" name="groc_quantity" required><br><br>
